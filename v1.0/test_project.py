...
import sqlite3
import csv
from project import hash_password, check_hashed_password, create_database, export_to_csv
...
def test_export_to_csv():
    # Delete any traces of previous csv files
    ...
    with open("data.csv", "r") as file:
        ...
        assert ["session_id", "user_id", "subject", "start_time", "duration"] == reader.fieldnames
